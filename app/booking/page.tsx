...
const REGIONS: Record<string, string[]> = {
  "الرياض": ["مركز فحص الرياض الشمالي", "مركز فحص الرياض الجنوبي", "مركز فحص الرياض الشرقي", "مركز فحص الرياض الغربي"],
  "مكة": ["مركز فحص مكة المكرمة", "مركز فحص جدة الشمالي", "مركز فحص جدة الجنوبي", "مركز فحص الطائف"],
  "الشرقية": ["مركز فحص الدمام", "مركز فحص الخبر", "مركز فحص الأحساء", "مركز فحص الجبيل"],
  "القصيم": ["مركز فحص بريدة", "مركز فحص عنيزة"],
  "المدينة": ["مركز فحص المدينة المنورة", "مركز فحص ينبع"],
  "عسير": ["مركز فحص أبها", "مركز فحص خميس مشيط"],
  "تبوك": ["مركز فحص تبوك"],
  "حائل": ["مركز فحص حائل"],
  "الشمالية": ["مركز فحص عرعر"],
  "جازان": ["مركز فحص جازان"],
  "نجران": ["مركز فحص نجران"],
  "الباحة": ["مركز فحص الباحة"],
  "الجوف": ["مركز فحص سكاكا"],
};

const TIMES = [
  "8:00 صباحاً","8:30 صباحاً","9:00 صباحاً","9:30 صباحاً",
  "10:00 صباحاً","10:30 صباحاً","11:00 صباحاً","11:30 صباحاً",
  "12:00 ظهراً","12:30 ظهراً","1:00 مساءً","1:30 مساءً",
      ...
      <div style={{ maxWidth: "500px", margin: "0 auto", padding: "20px" }}>
        ...
        <div style={formGroup}>
          ...
          <select value={selectedRegion} onChange={e => { setSelectedRegion(e.target.value); setSelectedCenter(""); }} style={selectStyle(errors.region)}>
            ...
            {Object.keys(REGIONS).map(r => <option key={r} value={r}>منطقة {r}</option>)}
          </select>
        </div>
        ...
        <div style={{ backgroundColor: "#fff5f5", borderRadius: "8px", padding: "15px", display: "flex", margin: "20px 0", border: "1px solid #ffebeb" }}>
          ...
          <p style={{ color: ERROR_RED, fontSize: "13px", lineHeight: "1.6", flex: 1 }}>
            تنبيه: يُرجى التأكد من صحة جميع البيانات المدخلة قبل المتابعة. لا يمكن استرداد رسوم الحجز بعد التأكيد.
          </p>
        </div>
